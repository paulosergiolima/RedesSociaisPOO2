...
public class User {
    ...
    public User(String userName, String nickName, String email, String pronouns, String profileDescription, int followers, int following, boolean accountPrivacy, LocalDateTime creationDate, int postsQuantity){
